...
public class BatteryManager {
	...
	public static double calculateWeight(Tile tileA, Tile tileB) {
		...
		else if ((tileA.getSurfaceType() == 1 && tileB.getSurfaceType() == 3) || (tileA.getSurfaceType() == 3 && tileB.getSurfaceType() == 1)) {
			weight = 2;
		}
		...
		else if ((tileA.getSurfaceType() == 2 && tileB.getSurfaceType() == 3) || (tileA.getSurfaceType() == 3 && tileB.getSurfaceType() == 2)) {
			weight = 2.5;
		}
